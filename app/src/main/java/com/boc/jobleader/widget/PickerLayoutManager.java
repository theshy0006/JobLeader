package com.boc.jobleader.widget;
...
public class PickerLayoutManager extends LinearLayoutManager {
    ...
    public static final class Builder {
         ...
         * 构建布局管理器
         */
        public com.boc.jobleader.widget.PickerLayoutManager build() {
            com.boc.jobleader.widget.PickerLayoutManager layoutManager = new com.boc.jobleader.widget.PickerLayoutManager(mContext, mOrientation, mReverseLayout, mMaxItem, mScale, mAlpha);
            if (mListener != null) {
