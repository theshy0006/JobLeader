...
import com.boc.jobleader.action.ActivityAction;
import com.boc.jobleader.action.AnimAction;
import com.boc.jobleader.action.ClickAction;
import com.boc.jobleader.action.HandlerAction;
import com.boc.jobleader.action.ResourcesAction;
...
public class BaseDialog extends AppCompatDialog implements LifecycleOwner,
    ...
    private final ListenersWrapper<com.boc.jobleader.base.BaseDialog> mListeners = new ListenersWrapper<>(this);
    ...
    public int getWindowAnimations() {
        ...
        return com.boc.jobleader.base.BaseDialog.ANIM_DEFAULT;
    }
     ...
     * @deprecated           请使用 {@link #addOnShowListener(com.boc.jobleader.base.BaseDialog.OnShowListener)}}
     */
    @Deprecated
    @Override
     ...
     * @deprecated           请使用 {@link #addOnCancelListener(com.boc.jobleader.base.BaseDialog.OnCancelListener)}
     */
    @Deprecated
    @Override
     ...
     * @deprecated           请使用 {@link #addOnDismissListener(com.boc.jobleader.base.BaseDialog.OnDismissListener)}
     */
    @Deprecated
    @Override
     ...
     * @deprecated           请使用 {@link #setOnKeyListener(com.boc.jobleader.base.BaseDialog.OnKeyListener)}
     */
    @Deprecated
    @Override
    ...
    public void setOnKeyListener(@Nullable com.boc.jobleader.base.BaseDialog.OnKeyListener listener) {
     ...
     */
    public void addOnShowListener(@Nullable com.boc.jobleader.base.BaseDialog.OnShowListener listener) {
     ...
     * @param listener      监听器对象
     */
    public void addOnCancelListener(@Nullable com.boc.jobleader.base.BaseDialog.OnCancelListener listener) {
     ...
     * @param listener      监听器对象
     */
    public void addOnDismissListener(@Nullable com.boc.jobleader.base.BaseDialog.OnDismissListener listener) {
     ...
     * @param listener      监听器对象
     */
    public void removeOnShowListener(@Nullable com.boc.jobleader.base.BaseDialog.OnShowListener listener) {
        if (mShowListeners != null) {
     ...
     * @param listener      监听器对象
     */
    public void removeOnCancelListener(@Nullable com.boc.jobleader.base.BaseDialog.OnCancelListener listener) {
        if (mCancelListeners != null) {
     ...
     * @param listener      监听器对象
     */
    public void removeOnDismissListener(@Nullable com.boc.jobleader.base.BaseDialog.OnDismissListener listener) {
        if (mDismissListeners != null) {
    ...
    public static class Builder<B extends Builder> implements LifecycleOwner, ActivityAction, ResourcesAction, ClickAction {
        ...
        /** Dialog 对象 */
        private com.boc.jobleader.base.BaseDialog mDialog;
        /** Dialog 布局 */
        ...
        /** 动画样式 */
        private int mAnimStyle = com.boc.jobleader.base.BaseDialog.ANIM_DEFAULT;
        /** 重心位置 */
        ...
        /** Dialog Key 监听 */
        private com.boc.jobleader.base.BaseDialog.OnKeyListener mOnKeyListener;
         ...
         * 添加显示监听
         */
        public B addOnShowListener(@NonNull com.boc.jobleader.base.BaseDialog.OnShowListener listener) {
            if (isCreated()) {
         ...
         * 添加取消监听
         */
        public B addOnCancelListener(@NonNull com.boc.jobleader.base.BaseDialog.OnCancelListener listener) {
            if (isCreated()) {
         ...
         * 添加销毁监听
         */
        public B addOnDismissListener(@NonNull com.boc.jobleader.base.BaseDialog.OnDismissListener listener) {
            if (isCreated()) {
         ...
         * 设置按键监听
         */
        public B setOnKeyListener(@NonNull com.boc.jobleader.base.BaseDialog.OnKeyListener listener) {
            if (isCreated()) {
         ...
         * 设置点击事件
         */
        public B setOnClickListener(@IdRes int id, @NonNull com.boc.jobleader.base.BaseDialog.OnClickListener listener) {
            if (isCreated()) {
        ...
        public com.boc.jobleader.base.BaseDialog create() {
            ...
            if (mAnimStyle == com.boc.jobleader.base.BaseDialog.ANIM_DEFAULT) {
                switch (mGravity) {
                    case Gravity.TOP:
                        mAnimStyle = com.boc.jobleader.base.BaseDialog.ANIM_TOP;
                        break;
                    case Gravity.BOTTOM:
                        mAnimStyle = com.boc.jobleader.base.BaseDialog.ANIM_BOTTOM;
                        break;
                    case Gravity.LEFT:
                        mAnimStyle = com.boc.jobleader.base.BaseDialog.ANIM_LEFT;
                        break;
                    case Gravity.RIGHT:
                        mAnimStyle = com.boc.jobleader.base.BaseDialog.ANIM_RIGHT;
                        break;
                    default:
                        mAnimStyle = com.boc.jobleader.base.BaseDialog.ANIM_DEFAULT;
                        break;
                }
            }
         ...
         * 显示
         */
        public com.boc.jobleader.base.BaseDialog show() {
            if (!isCreated()) {
                create();
            }
            mDialog.show();
         ...
         */
        protected com.boc.jobleader.base.BaseDialog createDialog(Context context, @StyleRes int themeId) {
            return new com.boc.jobleader.base.BaseDialog(context, themeId);
        }
         ...
         */
        @Nullable
        public com.boc.jobleader.base.BaseDialog getDialog() {
            return mDialog;
        }
    ...
    private static final class DialogLifecycle implements
            ...
            com.boc.jobleader.base.BaseDialog.OnShowListener,
            com.boc.jobleader.base.BaseDialog.OnDismissListener {

        private static void with(Activity activity, com.boc.jobleader.base.BaseDialog dialog) {
        ...
        private DialogLifecycle(Activity activity, com.boc.jobleader.base.BaseDialog dialog) {
            mActivity = activity;
        ...
        public void onActivityPaused(@NonNull Activity activity) {
            ...
            if (mDialog != null && mDialog.isShowing()) {
                ...
                // 设置 Dialog 无动画效果
                mDialog.setWindowAnimations(com.boc.jobleader.base.BaseDialog.ANIM_EMPTY);
            }
        }
        ...
        @Override
        public void onShow(com.boc.jobleader.base.BaseDialog dialog) {
            mDialog = dialog;
            registerActivityLifecycleCallbacks();
        }

        @Override
        public void onDismiss(com.boc.jobleader.base.BaseDialog dialog) {
            mDialog = null;
            unregisterActivityLifecycleCallbacks();
        }
    ...
    private static final class ViewClickWrapper
        ...
        private final com.boc.jobleader.base.BaseDialog mDialog;
        private final com.boc.jobleader.base.BaseDialog.OnClickListener mListener;

        private ViewClickWrapper(com.boc.jobleader.base.BaseDialog dialog, com.boc.jobleader.base.BaseDialog.OnClickListener listener) {
            mDialog = dialog;
            mListener = listener;
        }
    ...
    private static final class ShowListenerWrapper
            ...
            implements com.boc.jobleader.base.BaseDialog.OnShowListener {
    ...
    private static final class CancelListenerWrapper
            ...
            implements com.boc.jobleader.base.BaseDialog.OnCancelListener {
        ...
        @Override
        public void onCancel(com.boc.jobleader.base.BaseDialog dialog) {
            // 在横竖屏切换后监听对象会为空
            if (get() != null) {
                get().onCancel(dialog);
            }
    ...
    private static final class DismissListenerWrapper
            ...
            implements com.boc.jobleader.base.BaseDialog.OnDismissListener {
    ...
    private static final class KeyListenerWrapper
        ...
        private final com.boc.jobleader.base.BaseDialog.OnKeyListener mListener;

        private KeyListenerWrapper(com.boc.jobleader.base.BaseDialog.OnKeyListener listener) {
            mListener = listener;
        }
        ...
        public boolean onKey(DialogInterface dialog, int keyCode, KeyEvent event) {
            // 在横竖屏切换后监听对象会为空
            if (mListener != null && dialog instanceof com.boc.jobleader.base.BaseDialog) {
                mListener.onKey((com.boc.jobleader.base.BaseDialog) dialog, event);
            }
            return false;
        }
    }
    ...
    public interface OnClickListener<V extends View> {
        void onClick(com.boc.jobleader.base.BaseDialog dialog, V view);
    }
    ...
    public interface OnShowListener {
         ...
         * Dialog 显示了
         */
        void onShow(com.boc.jobleader.base.BaseDialog dialog);
    }
    ...
    public interface OnCancelListener {
         ...
         * Dialog 取消了
         */
        void onCancel(com.boc.jobleader.base.BaseDialog dialog);
    }
    ...
    public interface OnDismissListener {
         ...
         * Dialog 销毁了
         */
        void onDismiss(com.boc.jobleader.base.BaseDialog dialog);
    }
    ...
    public interface OnKeyListener {
         ...
         * 触发了按键
         */
        boolean onKey(com.boc.jobleader.base.BaseDialog dialog, KeyEvent event);
    }
}