package com.boc.jobleader.help;
...
public final class ActivityStackManager implements Application.ActivityLifecycleCallbacks {
    ...
    private static volatile com.boc.jobleader.help.ActivityStackManager sInstance;
    ...
    public static com.boc.jobleader.help.ActivityStackManager getInstance() {
        // 加入双重校验锁
        if(sInstance == null) {
            synchronized (com.boc.jobleader.help.ActivityStackManager.class) {
                if(sInstance == null){
                    sInstance = new com.boc.jobleader.help.ActivityStackManager();
                }
            }
        }
        return sInstance;
