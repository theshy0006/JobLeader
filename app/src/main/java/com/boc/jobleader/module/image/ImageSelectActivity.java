...
import com.boc.jobleader.aop.Permissions;
import com.boc.jobleader.aop.SingleClick;
import com.boc.jobleader.base.BaseActivity;
import com.boc.jobleader.widget.GridSpaceDecoration;
import com.boc.jobleader.http.other.IntentKey;
import com.boc.jobleader.utils.ImageSelectAdapter;
import com.boc.jobleader.dialog.AlbumDialog;
...
public final class ImageSelectActivity extends MyActivity
    ...
    public static void start(BaseActivity activity, int maxSelect, OnPhotoSelectListener listener) {
        ...
        Intent intent = new Intent(activity, com.boc.jobleader.module.image.ImageSelectActivity.class);
    ...
    protected void initData() {
        ...
        showLoading();
        // 加载图片列表
        new Thread(com.boc.jobleader.module.image.ImageSelectActivity.this).start();
    }
    ...
    public void onItemClick(RecyclerView recyclerView, View itemView, int position) {
        if (mSelectImage.contains(mAdapter.getItem(position))) {
            com.boc.jobleader.module.image.ImagePreviewActivity.start(getActivity(), mSelectImage, mSelectImage.indexOf(mAdapter.getItem(position)));
        } else {
            com.boc.jobleader.module.image.ImagePreviewActivity.start(getActivity(), mAdapter.getItem(position));
        }
    }
